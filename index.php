...
<head>
    ...
    <title>E MEDICAL SERVICES</title>
...
<body>
    <section class="colored-section" id="title">
        ...
        <!-- Nav Bar -->
          ...
          <a class="navbar-brand" href=""><h1>E MEDICAL SERVICES</h1></a>
        ...
        <div class="row">
          <div class="col-lg-6">
            <h1 class="big-heading ml-4">WELCOME TO THE E MEDICAL SERVICES</h1>
      ...
      <div id="direction-carousel" class="carousel slide" data-ride="false">
        <div class="carousel-inner">
          <div class="carousel-item active container-fluid">
              ...
              <p class="dir-para">E MEDICAL SERVICES's team of qualified doctors is always ready to help you.</p>
    ...
    <Section class="white-section" id="about-section">
        <div class="row about-sec">
            ...
            <div class="col-lg-6">
                ...
                <p class="about-para">E MEDICAL SERVICES is a Federally Qualified Health Center providing high-quality healthcare services.
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-6">
            <p class="text-muted">Blog|Privacy |Refund |Policy |Terms & Condition</p>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6">
            <p class="text-muted">2022 &#169; GlobalHealth. All rights reserved. | Privacy Policy</p>
          </div>
       </div>
      </div>
    </footer>
