...
--
-- Host: 127.0.0.1
-- Generation Time: May 16, 2022 at 07:05 PM
...
INSERT INTO `appointment` (`sno`, `user_emailid`, `doc_emailid`, `specialization`, `disease`, `appointmentdate`, `appointmenttime`, `consultancyfees`, `userstatus`, `doctorstatus`, `meeting_url`) VALUES
(1, 'ganapathy5@gmail.com', 'venky@gmail.com', 'Dermatology', 'Acne(10days)', '2021-07-30', '16:00:00', '1000', 1, 2, 'https://us05web.zoom.us/j/84656207326?pwd=MG4yUkgzRDJSVUI2K0RMNlNnaEwxQT09'),
(2, 'ganapathy5@gmail.com', 'kabilan@gmail.com', 'Dermatology', 'fever(10days)', '2021-07-23', '15:00:00', '1000', 0, 1, 'https://us05web.zoom.us/j/84656207326?pwd=MG4yUkgzRDJSVUI2K0RMNlNnaEwxQT09'),
(3, 'ganapathy5@gmail.com', 'kabilan@gmail.com', 'Dermatology', 'fever(15days)', '2021-07-24', '15:00:00', '1000', 1, 0, 'https://us05web.zoom.us/j/84656207326?pwd=MG4yUkgzRDJSVUI2K0RMNlNnaEwxQT09');
...
--
-- Alter For Appointment table
--

ALTER TABLE `appointment`   
	ADD COLUMN `expert_list` json NULL AFTER `meeting_url`;

ALTER TABLE `appointment`   
	CHANGE `meeting_url` `meeting_url` VARCHAR(255) NULL;

ALTER TABLE `appointment`   
	ADD COLUMN `meeting_preference` ENUM('WHATSAPP','ZOOM') NULL AFTER `expert_list`;